...
Als eine Lösung für das Problem werden unterschiedliche Launch-Dateien für die beiden Robotern angelegt, in denen die Nachrichtennamen den Robotern angepasst werden. Hierbei handelt es sich um eine recht umständliche und unflexible Lösung, die allerdings funktioniert. \pdfcomment{Nicht gut; aber geht}

\newpage
\input{1_Systemstruktur}

\newpage
\input{2_Inbetriebnahme}