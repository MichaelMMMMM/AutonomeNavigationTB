...
%Mit / unter bedingung,dass
\newcommand{\mCond}{\hspace{1mm} \vert \hspace{1mm}}
%believe
\newcommand{\bel}[1]{\text{bel}\left({#1}\right)}
%pre-believe
\newcommand{\pbel}[1]{\overline{\text{bel}}\left({#1}\right)}
%Bedingte Wahrscheinlichkeit
\newcommand{\condP}[2]{p\left({#1} \hspace{1mm} \vert \hspace{1mm} {#2}\right)}
